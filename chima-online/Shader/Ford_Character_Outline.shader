...
//
///////////////////////////////////////////
Shader "Ford/Ford_Character_Outline" {
Properties {
 ...
 _TransparentColor ("Transparent Color", Color) = (0,0.5,1,0.2)
 _GoodBad ("Good or Bad (0 or 1)", Float) = 1
}
SubShader { 
 Tags { "QUEUE"="Geometry+2" "IGNOREPROJECTOR"="False" "RenderType"="Opaque" }
 UsePass "Ford/Base_Passes/OUTLINE"
 UsePass "Ford/Base_Passes/GHOST"
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardBase" "SHADOWSUPPORT"="true" "QUEUE"="Geometry+2" "IGNOREPROJECTOR"="False" "RenderType"="Opaque" }
  ColorMask RGB
Program "vp" {
SubProgram "opengl " {
...
apaaaaaafdfgfpfegbhcghgfheaaklkl"
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardAdd" "QUEUE"="Geometry+2" "IGNOREPROJECTOR"="False" "RenderType"="Opaque" }
  ZWrite Off
  Fog {
   Color (0,0,0,0)
  }
