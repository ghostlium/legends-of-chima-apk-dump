...
//
///////////////////////////////////////////
Shader "Ford/Transparent/Scroll 2 Layers Sine Add" {
Properties {
...
MOV R1.w, c[15].x;
MUL R1.w, R1, c[5].x;
MAD R1.w, R1, c[0].z, -c[0];
MUL R0.xyz, R0, R0;
MAD result.texcoord[0].z, R1.x, c[17].x, R2.x;
MUL R1.xyz, R0, c[0].xyxw;
ADD R1.xyz, R1, c[23].xyxw;
MAD R1.xyz, R1, R0, c[23].zwzw;
MAD R2.xyz, R1, R0, c[24].xyxw;
MAD R2.xyz, R2, R0, c[24].zwzw;
FRC R2.w, R1;
ADD R1.xyz, -R2.w, c[22];
MUL R1.xyz, R1, R1;
MAD R3.xyz, R2, R0, c[22].wzww;
MUL R2.xyz, R1, c[0].xyxw;
SLT R4.x, R0.w, c[0].w;
SGE R4.yz, R0.w, c[25].xxyw;
MOV R0.xz, R4;
DP3 R0.y, R4, c[22].wzww;
DP3 R0.w, R3, -R0;
ADD R0.xyz, R2, c[23].xyxw;
MAD R0.xyz, R0, R1, c[23].zwzw;
MAD R0.xyz, R0, R1, c[24].xyxw;
MAD R3.xy, vertex.texcoord[0], c[6], c[6].zwzw;
MOV R2.y, c[9].x;
MOV R2.x, c[8];
MUL R2.xy, R2, c[5];
FRC R2.xy, R2;
ADD R4.xy, R3, R2;
MAD R2.xyz, R0, R1, c[24].zwzw;
MAD result.texcoord[0].y, R0.w, c[14].x, R4;
MOV R0, c[21];
MAD R2.xyz, R2, R1, c[22].wzww;
MUL R1, R0, c[12].x;
MUL R1, R1, vertex.color;
SLT R3.x, R2.w, c[0].w;
SGE R3.yz, R2.w, c[25].xxyw;
MOV R0.xz, R3;
DP3 R0.y, R3, c[22].wzww;
DP3 R0.x, R2, -R0;
...
"vs_4_0
eefiecedpjpockafapienocdbbnfmeghgmjfecejabaaaaaaeiafaaaaadaaaaaa
...
aaklklklfdeieefcnmadaaaaeaaaabaaphaaaaaafjaaaaaeegiocaaaaaaaaaaa
...

aaaaaaaadoaaaaab"
}
SubProgram "d3d11_9x " {
Keywords { "LIGHTMAP_OFF" }
...
BindCB  "UnityPerDraw" 2
"vs_4_0_level_9_1

...
ahaaoekaabaaaaacaaaaahiaabaaoeiaafaaaaadaaaaapiaaaaaoeiaafaaoeja
...
aaaaammaaaaaoeiappppaaaafdeieefcnmadaaaaeaaaabaaphaaaaaafjaaaaae
...

