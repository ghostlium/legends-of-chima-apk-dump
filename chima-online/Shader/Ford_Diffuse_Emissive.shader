...
//
///////////////////////////////////////////
Shader "Ford/Diffuse Emissive" {
Properties {
 _Color ("Main Color", Color) = (1,1,1,1)
 _EmissiveColor ("_Emissive Color", Color) = (0,0,0,0)
 _MainTex ("Base (RGB)", 2D) = "white" {}
 _Bias ("Emissive Bias", Float) = 0
 _TimeOnDuration ("Emissive ON duration", Float) = 0.5
 _TimeOffDuration ("Emissive OFF duration", Float) = 0.5
}
SubShader { 
 LOD 200
...
"vs_4_0_level_9_1
eefiecedkigloagkakejnalgekpagdobgaepbjhhabaaaaaageaiaaaaaeaaaaaa
daaaaaaanaacaaaapmagaaaameahaaaaebgpgodjjiacaaaajiacaaaaaaacpopp
ciacaaaahaaaaaaaagaaceaaaaaagmaaaaaagmaaaaaaceaaabaagmaaaaaaakaa
...
BindCB  "UnityPerDraw" 3
"vs_4_0_level_9_1
eefiecednbknoeckaelolgekapajomommhpokpbjabaaaaaalianaaaaaeaaaaaa
daaaaaaaneaeaaaafaamaaaabianaaaaebgpgodjjmaeaaaajmaeaaaaaaacpopp
caaeaaaahmaaaaaaahaaceaaaaaahiaaaaaahiaaaaaaceaaabaahiaaaaaaakaa
...
nnabaaaafjaaaaaeegiocaaaaaaaaaaaalaaaaaafjaaaaaeegiocaaaabaaaaaa
...
MUL R1.x, R1, R1.z;
MOV R1.y, c[9];
CMP R1.x, c[0].y, -R1, R1;
MAD R2.x, R1.y, -c[6], R1;
MAD R1.w, R1.y, -c[6].x, c[6].x;
MOV R1.z, c[8];
MUL R1.y, R1.z, c[6].x;
RCP R1.z, R1.w;
MUL_SAT R1.z, R2.x, R1;
RCP R1.y, R1.y;
MUL_SAT R1.x, R1, R1.y;
MAD R1.w, -R1.z, c[8].y, c[8];
MUL R1.y, R1.z, R1.z;
MAD R1.z, -R1.y, R1.w, c[9].x;
MAD R1.y, -R1.x, c[8], c[8].w;
MUL R1.x, R1, R1;
MUL R1.x, R1, R1.y;
MAD R1.x, R1, R1.z, c[5];
MUL R2.xyz, R1.x, c[4];
...
"ps_2_0
dcl_2d s0
def c8, 0.25000000, 0.75000000, 2.00000000, 3.00000000
...
Float 80 [_Bias]
Float 84 [_TimeOnDuration]
Float 88 [_TimeOffDuration]
ConstBuffer "UnityPerCamera" 128
Vector 0 [_Time]
ConstBuffer "UnityLighting" 720
...
BindCB  "UnityLighting" 2
"ps_4_0_level_9_1

...

...
adaaaaaaaaaaaaajbcaabaaaaaaaaaaackiacaaaaaaaaaaaafaaaaaabkiacaaa
aaaaaaaaafaaaaaaaoaaaaaiccaabaaaaaaaaaaabkiacaaaabaaaaaaaaaaaaaa
akaabaaaaaaaaaaabnaaaaaiecaabaaaaaaaaaaabkaabaaaaaaaaaaabkaabaia
...

...
ccaabaaaaaaaaaaabkaabaiaebaaaaaaaaaaaaaackaabaaaaaaaaaaaabeaaaaa
aaaaiadpdcaaaaajecaabaaaaaaaaaaaakaabaaaaaaaaaaaabeaaaaaaaaaaama
...
aaaaaaaaafaaaaaabaaaaaaiccaabaaaaaaaaaaaegbcbaaaacaaaaaaegiccaaa
acaaaaaaaaaaaaaadeaaaaahccaabaaaaaaaaaaabkaabaaaaaaaaaaaabeaaaaa
aaaaaaaaaaaaaaahccaabaaaaaaaaaaabkaabaaaaaaaaaaabkaabaaaaaaaaaaa
...
dgaaaaaficcabaaaaaaaaaaadkaabaaaabaaaaaadcaaaaajocaabaaaaaaaaaaa
agajbaaaacaaaaaafgafbaaaaaaaaaaaagajbaaaabaaaaaadcaaaaakhccabaaa
aaaaaaaaegiccaaaaaaaaaaaaeaaaaaaagaabaaaaaaaaaaajgahbaaaaaaaaaaa
...
MUL R0.w, R0, c[0].y;
ABS R0.w, R0;
DP3 R2.z, fragment.texcoord[1], c[1];
ABS R2.y, R2;
FRC R0.w, R0;
MUL R0.w, R0, R2.y;
MAX R2.y, R2.z, c[8].x;
...
MOV R2.y, c[9];
MUL R0.xyz, R2.x, R0;
CMP R0.w, c[0].y, -R0, R0;
MUL R1.xyz, R1, fragment.texcoord[2];
MAD R2.x, R2.y, -c[6], R0.w;
MOV R2.z, c[8];
MAD R2.w, R2.y, -c[6].x, c[6].x;
MUL R2.y, R2.z, c[6].x;
RCP R2.z, R2.w;
RCP R2.y, R2.y;
MUL_SAT R2.x, R2, R2.z;
MUL_SAT R0.w, R0, R2.y;
MAD R2.y, -R2.x, c[8], c[8].w;
MUL R2.x, R2, R2;
MAD R2.y, -R2.x, R2, c[9].x;
MAD R2.x, -R0.w, c[8].y, c[8].w;
MUL R0.w, R0, R0;
MUL R0.w, R0, R2.x;
MAD R0.w, R0, R2.y, c[5].x;
MUL R2.xyz, R0.w, c[4];
MAD R0.xyz, R0, c[8].y, R1;
ADD result.color.xyz, R0, R2;
...
Float 144 [_Bias]
Float 148 [_TimeOnDuration]
Float 152 [_TimeOffDuration]
ConstBuffer "UnityPerCamera" 128
Vector 0 [_Time]
ConstBuffer "UnityLighting" 720
Vector 0 [_WorldSpaceLightPos0]
...
BindCB  "UnityLighting" 2
"ps_4_0_level_9_1
eefiecedfpoomadibdbphmmafpidbhnhpmpbehapabaaaaaahmaiaaaaaeaaaaaa
daaaaaaacmadaaaakiahaaaaeiaiaaaaebgpgodjpeacaaaapeacaaaaaaacpppp
...
abaaaeaaaaaaaaaaacaaaaaaabaaafaaaaaaaaaaaaacppppfbaaaaafagaaapka
aaaaiadoaaaaaamaaaaaeaeaaaaaeadpfbaaaaafahaaapkaaaaaiadpaaaaaaaa
...

...

...
abeaaaaaaaaaiadpdcaaaaajecaabaaaaaaaaaaaakaabaaaaaaaaaaaabeaaaaa
...
aaaaaaaadcaaaaakbcaabaaaaaaaaaaaakaabaaaaaaaaaaabkaabaaaaaaaaaaa
akiacaaaaaaaaaaaajaaaaaaaoaaaaahgcaabaaaaaaaaaaaagbbbaaaaeaaaaaa
...
egiccaaaacaaaaaaaaaaaaaadeaaaaahccaabaaaaaaaaaaabkaabaaaaaaaaaaa
abeaaaaaaaaaaaaaapaaaaahccaabaaaaaaaaaaafgafbaaaaaaaaaaaagaabaaa
...

...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedlgahgnaeahpmfaehfnhliehfcabfafamabaaaaaakaaeaaaaaeaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedjdiocbifpkcjnaiemcgecbkdbchklkolabaaaaaahiadaaaaaeaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedpfahnecmknicpnpminomlebanmbkbfjaabaaaaaapeafaaaaaeaaaaaa
...
aaaaciiaacaaffkaabaaaaacaaaicpiaaaaaoeiappppaaaafdeieefcaaadaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedkaaocjegdmnlhjdmhlgeghpipadmkdneabaaaaaaciafaaaaaeaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedejpggojihfopobjkejmohibpndabkdahabaaaaaabmaeaaaaaeaaaaaa
