...
//
///////////////////////////////////////////
Shader "Ford/Ford_CharacterEditor" {
Properties {
...
SubShader { 
 Tags { "QUEUE"="Geometry+3" "IGNOREPROJECTOR"="False" "RenderType"="Opaque" }
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardBase" "SHADOWSUPPORT"="true" "QUEUE"="Geometry+3" "IGNOREPROJECTOR"="False" "RenderType"="Opaque" }
Program "vp" {
...
"
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardAdd" "QUEUE"="Geometry+3" "IGNOREPROJECTOR"="False" "RenderType"="Opaque" }
  ZWrite Off
  Fog {
   Color (0,0,0,0)
  }
