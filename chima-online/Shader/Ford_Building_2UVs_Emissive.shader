...
//
///////////////////////////////////////////
Shader "Ford/Ford_Building_2UVs_Emissive" {
Properties {
...
Vector 6 [_FeedbackColor]
Vector 7 [_EmissiveColor]
...
MAX R1.x, R1.y, c[8].z;
POW R1.y, R1.x, R1.z;
MAD R1.x, -R1.w, fragment.texcoord[5].z, c[8].y;
ADD R1.z, -R1.y, c[4].x;
POW R1.x, R1.x, c[2].x;
MAD R1.w, R1.x, R1.z, R1.y;
MOV R1.xyz, c[9];
DP3 R2.w, R1, c[0];
MAX R3.x, fragment.texcoord[3].z, c[8].z;
MUL R1.xyz, R3.x, c[0];
MUL R1.w, R1, R2;
MUL R1, R1, c[9].w;
MUL R1.w, R1, c[1].x;
...
dcl_2d s0
dcl_2d s1
def c8, 10.00000000, 1.00000000, 0.00000000, 128.00000000
def c9, 0.21997070, 0.70703125, 0.07098389, 2.00000000
dcl t0.xy
dcl t2.xy
dcl t3.xyz
dcl t4.xyz
...
mul_pp r0.z, r2.x, r1
mov_pp r1.x, c3
max_pp r2.x, r0.z, c8.z
mul_pp r1.x, c8.w, r1
pow r5.x, r2.x, r1.x
mad_pp r0.x, -r0, t5.z, c8.y
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...

...
dcaaaaajocaabaaaaaaaaaaaagbjbaaaafaaaaaaagaabaaaaaaaaaaaagbjbaaa
adaaaaaadcaaaaakbcaabaaaaaaaaaaackbabaiaebaaaaaaafaaaaaaakaabaaa
...
ccaabaaaaaaaaaaabkaabaaaaaaaaaaadiaaaaaiecaabaaaaaaaaaaackiacaaa
...

...
aaaaaaaaegacbaaaabaaaaaapgapbaaaacaaaaaaegacbaaaaaaaaaaadcaaaaaj
hcaabaaaaaaaaaaaegacbaaaacaaaaaaegbcbaaaaeaaaaaaegacbaaaaaaaaaaa
dcaaaaalhccabaaaaaaaaaaaegiccaaaaaaaaaaaahaaaaaaagiacaaaaaaaaaaa
...
dcl_2d s0
dcl_2d s1
def c3, 8.00000000, 10.00000000, 1.00000000, 0
dcl t0.xy
dcl t3.xy
texld r0, t0, s0
texld r1, t3, s1
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedhmgnoegcmbeobiphjiflhlphdfcnfaldabaaaaaapeadaaaaaeaaaaaa
...

...
hcaabaaaaaaaaaaaegacbaaaaaaaaaaaegiccaaaaaaaaaaaagaaaaaadiaaaaak
hcaabaaaaaaaaaaaegacbaaaaaaaaaaaaceaaaaaaaaacaebaaaacaebaaaacaeb
...
diaaaaajhcaabaaaacaaaaaaagiacaaaaaaaaaaaafaaaaaaegiccaaaaaaaaaaa
ahaaaaaadcaaaaajhccabaaaaaaaaaaaegacbaaaaaaaaaaaegacbaaaabaaaaaa
...
aaaaaaaaadaaaaaaacaaaaaaadaaaaaaimaaaaaaadaaaaaaaaaaaaaaadaaaaaa
...
MOV R1.xyz, c[9];
DP3 R2.w, R1, c[0];
MAX R3.y, fragment.texcoord[3].z, c[8].z;
MUL R1.xyz, R3.y, c[0];
MUL R1.w, R1, R2;
MUL R1, R3.x, R1;
MUL R1, R1, c[9].w;
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...

...
afaaaaaaagaabaaaaaaaaaaaagbjbaaaadaaaaaadcaaaaakbcaabaaaaaaaaaaa
ckbabaiaebaaaaaaafaaaaaaakaabaaaaaaaaaaaabeaaaaaaaaaiadpcpaaaaaf
...
aaaaaaaabaaaaaahccaabaaaaaaaaaaajgahbaaaaaaaaaaajgahbaaaaaaaaaaa
...

...

...
dcl_2d s1
dcl_2d s2
def c3, 8.00000000, 2.00000000, 10.00000000, 1.00000000
dcl t0.xy
dcl t3.xy
dcl t4
texld r1, t0, s0
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedofgpfjifjjeblgmknmdbfmfgjmfgifkoabaaaaaajiafaaaaaeaaaaaa
daaaaaaaamacaaaakmaeaaaageafaaaaebgpgodjneabaaaaneabaaaaaaacpppp
...
aaaacaebaaaaaaebaaaaiadpaaaaaaaabpaaaaacaaaaaaiaaaaaaplabpaaaaac
...

...
akaaaaaadiaaaaakhcaabaaaabaaaaaaegacbaaaabaaaaaaaceaaaaaaaaacaeb
aaaacaebaaaacaebaaaaaaaadiaaaaajhcaabaaaacaaaaaaagiacaaaaaaaaaaa
ajaaaaaaegiccaaaaaaaaaaaalaaaaaadcaaaaajhccabaaaaaaaaaaaegacbaaa
...
amaaaaaakeaaaaaaacaaaaaaaaaaaaaaadaaaaaaacaaaaaaadaaaaaakeaaaaaa
...
RSQ R1.w, R1.x;
MAD R1.xyz, R1.w, fragment.texcoord[4], R3;
DP3 R1.x, R1, R1;
RSQ R1.y, R1.x;
MUL R1.y, R1, R1.z;
MOV R1.x, c[6].z;
...
MUL R3.xyz, R1, R1.w;
MUL R0.xyz, R0, R1;
MAD R0.xyz, R0, c[7].w, R3;
MAD result.color.xyz, R2, R0.w, R0;
END
# 35 instructions, 4 R-regs
"
}
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...

...
diaaaaahocaabaaaaaaaaaaaagaabaaaaaaaaaaaagbjbaaaaeaaaaaadcaaaaak
...

...
ckiacaaaaaaaaaaaaiaaaaaaabeaaaaaaaaaaaeddiaaaaahccaabaaaaaaaaaaa
...
aaaaaaaaaiaaaaaadcaaaaajbcaabaaaaaaaaaaaakaabaaaaaaaaaaackaabaaa
...
abaaaaaabkaabaaaaaaaaaaaakaabaaaaaaaaaaabaaaaaahbcaabaaaaaaaaaaa
...
akaabaaaaaaaaaaaakaabaaaaaaaaaaadiaaaaahpcaabaaaaaaaaaaaagaabaaa
aaaaaaaaegaobaaaabaaaaaadiaaaaaiicaabaaaaaaaaaaadkaabaaaaaaaaaaa
akiacaaaaaaaaaaaaiaaaaaadiaaaaahhcaabaaaabaaaaaapgapbaaaaaaaaaaa
...
egiccaaaaaaaaaaaakaaaaaadiaaaaakhcaabaaaacaaaaaaegacbaaaacaaaaaa
...
abaaaaaaegbabaaaacaaaaaaeghobaaaabaaaaaaaagabaaaacaaaaaadcaaaaaj
...
acaaaaaaadadaaaalmaaaaaaadaaaaaaaaaaaaaaadaaaaaaadaaaaaaahahaaaa
...
MOV R1.xyz, c[7];
DP3 R2.w, R1, c[0];
MAX R3.x, fragment.texcoord[3].z, c[6];
MUL R1.xyz, R3.x, c[0];
MUL R1.w, R1, R2;
MUL R1, R1, c[6].w;
MUL R1.w, R1, c[1].x;
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...

...
aaaacaebaaaacaebaaaacaebaaaaaaaadcaaaaajhcaabaaaaaaaaaaaegacbaaa
acaaaaaaegacbaaaaaaaaaaaegacbaaaabaaaaaaefaaaaajpcaabaaaabaaaaaa
egbabaaaacaaaaaaeghobaaaabaaaaaaaagabaaaabaaaaaadcaaaaajhccabaaa
...
adadaaaakeaaaaaaadaaaaaaaaaaaaaaadaaaaaaadaaaaaaahahaaaakeaaaaaa
...
MUL R3.xyz, R1.y, fragment.texcoord[3];
RSQ R3.w, R1.x;
MAD R1.xyz, R3.w, fragment.texcoord[4], R3;
DP3 R1.x, R1, R1;
RSQ R1.y, R1.x;
MAD R3.w, -R3, fragment.texcoord[4].z, c[6].z;
MUL R1.y, R1, R1.z;
MOV R1.x, c[6].w;
MUL R1.z, R1.x, c[3].x;
MAX R1.x, R1.y, c[6];
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...
aaaaaaaabkaabaaaaaaaaaaabaaaaaalccaabaaaaaaaaaaaegiccaaaaaaaaaaa
abaaaaaaaceaaaaakoehgbdopepndedphdgijbdnaaaaaaaadiaaaaahicaabaaa
abaaaaaabkaabaaaaaaaaaaaakaabaaaaaaaaaaaaoaaaaahdcaabaaaaaaaaaaa
...

...
adaaaaaaabaaaaaaamaaaaaalmaaaaaaacaaaaaaaaaaaaaaadaaaaaaacaaaaaa
adadaaaalmaaaaaaadaaaaaaaaaaaaaaadaaaaaaadaaaaaaahahaaaalmaaaaaa
...
DP3 R1.x, R1, R1;
RSQ R1.y, R1.x;
MAD R3.w, -R3, fragment.texcoord[4].z, c[6].y;
MUL R1.y, R1, R1.z;
MOV R1.x, c[6].z;
MUL R1.z, R1.x, c[3].x;
MAX R1.x, R1.y, c[6];
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...

...
agbjbaaaaeaaaaaadcaaaaakbcaabaaaaaaaaaaackbabaiaebaaaaaaaeaaaaaa
...

...

...
abaaaaaaaagabaaaadaaaaaadcaaaaajhccabaaaaaaaaaaaegacbaaaabaaaaaa
pgapbaaaacaaaaaaegacbaaaaaaaaaaadgaaaaaficcabaaaaaaaaaaaabeaaaaa
...
lmaaaaaaacaaaaaaaaaaaaaaadaaaaaaacaaaaaaadadaaaalmaaaaaaadaaaaaa
...
MOV R1.xyz, c[7];
DP3 R3.x, R1, c[0];
MAX R3.y, fragment.texcoord[3].z, c[6].x;
MUL R1.w, R1, R3.x;
MUL R1.xyz, R3.y, c[0];
MUL R1, R2.w, R1;
MUL R1, R1, c[6].w;
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...
adaaoelaahaaaaacaaaacbiaaaaappiaabaaaaacabaaahiaadaaoelaaeaaaaae
abaachiaabaaoeiaaaaaaaiaacaaoelaaeaaaaaeabaaaiiaadaakklaaaaaaaib
adaappkacaaaaaadaaaacbiaabaappiaabaaffkaaiaaaaadaaaacciaabaaoeia
...

...
aaaachiaacaaoeiaaaaaoeiaabaaoeiaaeaaaaaeaaaachiaadaaoeiaacaappia
aaaaoeiaabaaaaacaaaaaiiaadaaffkaabaaaaacaaaicpiaaaaaoeiappppaaaa
fdeieefckaaeaaaaeaaaaaaaciabaaaafjaaaaaeegiocaaaaaaaaaaaalaaaaaa
...
agbjbaaaaeaaaaaaagaabaaaaaaaaaaaagbjbaaaadaaaaaadcaaaaakbcaabaaa
aaaaaaaackbabaiaebaaaaaaaeaaaaaaakaabaaaaaaaaaaaabeaaaaaaaaaiadp
...

...

fdfgfpfegbhcghgfheaaklkl"
}
...
TEMP R1;
TEMP R2;
TXP R1, fragment.texcoord[3], texture[2], 2D;
TEX R0, fragment.texcoord[0], texture[0], 2D;
TEX R2.xyz, fragment.texcoord[2], texture[1], 2D;
LG2 R1.w, R1.w;
MUL R1.w, -R1, c[0].x;
...
dcl_2d s1
dcl_2d s2
def c4, 10.00000000, 1.00000000, 0, 0
dcl t0.xy
dcl t2.xy
dcl t3
dcl t4.xyz
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...

...
egacbaaaabaaaaaapgapbaaaacaaaaaaegacbaaaaaaaaaaadcaaaaalhccabaaa
aaaaaaaaegiccaaaaaaaaaaaahaaaaaaagiacaaaaaaaaaaaafaaaaaaegacbaaa
...
abaaaaaaaaaaaaaaadaaaaaaabaaaaaaamaaaaaakeaaaaaaacaaaaaaaaaaaaaa
adaaaaaaacaaaaaaadadaaaakeaaaaaaadaaaaaaaaaaaaaaadaaaaaaadaaaaaa
...
TEX R4.xyz, fragment.texcoord[2], texture[1], 2D;
MUL R3.xyz, R3.w, R3;
MUL R2.xyz, R2.w, R2;
MUL R2.xyz, R2, c[5].x;
...
dcl_2d s3
dcl_2d s4
def c5, 8.00000000, 10.00000000, 1.00000000, 0
dcl t0.xy
dcl t2.xy
dcl t3
dcl t4.xy
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1

...
aaaaaaiaaeaakkkaaeaappkaabaaaaacabaaadiaabaabllaagaaaaacaaaaacia
...
abaioekaafaaaaadadaaciiaadaappiaafaaffkaafaaaaadaaaacoiaadaablia
adaappiaafaaaaadabaaciiaabaappiaafaaffkaaeaaaaaeabaachiaabaappia
...

...
dkaabaiaebaaaaaaabaaaaaaakiacaaaaaaaaaaaaeaaaaaadiaaaaahhcaabaaa
...
acaaaaaaegacbaaaacaaaaaaegiccaaaaaaaaaaaagaaaaaadiaaaaakhcaabaaa
...
aagabaaaabaaaaaadcaaaaajhcaabaaaaaaaaaaaegacbaaaabaaaaaapgapbaaa
acaaaaaaegacbaaaaaaaaaaadcaaaaalhccabaaaaaaaaaaaegiccaaaaaaaaaaa
ahaaaaaaagiacaaaaaaaaaaaafaaaaaaegacbaaaaaaaaaaadgaaaaaficcabaaa
...
abaaaaaaamaaaaaalmaaaaaaacaaaaaaaaaaaaaaadaaaaaaacaaaaaaadadaaaa
lmaaaaaaaeaaaaaaaaaaaaaaadaaaaaaacaaaaaaamamaaaalmaaaaaaadaaaaaa
aaaaaaaaadaaaaaaadaaaaaaapalaaaalmaaaaaaafaaaaaaaaaaaaaaadaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedmgfnhchpafcciakdahopfoblbkclmdfhabaaaaaadmafaaaaaeaaaaaa
daaaaaaaoeabaaaafaaeaaaaaiafaaaaebgpgodjkmabaaaakmabaaaaaaacpppp
...

...

...
abaaaaaaamaaaaaakeaaaaaaacaaaaaaaaaaaaaaadaaaaaaacaaaaaaadadaaaa
keaaaaaaadaaaaaaaaaaaaaaadaaaaaaadaaaaaaapalaaaakeaaaaaaaeaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedjmcblffghgcogpgmnhgondjiamodbldiabaaaaaamiahaaaaaeaaaaaa
daaaaaaanaacaaaameagaaaajeahaaaaebgpgodjjiacaaaajiacaaaaaaacpppp
...
aeaaaaaeaaaachiaafaaoeiaaeaappiaaaaaoeiaabaaaaacabaaahiaadaaoeka
aeaaaaaeaaaachiaabaaoeiaabaaaakaaaaaoeiaabaaaaacaaaaciiaafaakkka
abaaaaacaaaicpiaaaaaoeiappppaaaafdeieefcomadaaaaeaaaaaaaplaaaaaa
...

gbhcghgfheaaklkl"
}
