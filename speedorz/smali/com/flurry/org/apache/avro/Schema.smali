...
.method static parse(Lcom/flurry/org/codehaus/jackson/JsonNode;Lcom/flurry/org/apache/avro/Schema$Names;)Lcom/flurry/org/apache/avro/Schema;
    ...
    .line 1104
    .local v24, "result":Lcom/flurry/org/apache/avro/Schema;
    if-nez v24, :cond_23

    .line 1105
    new-instance v35, Lcom/flurry/org/apache/avro/SchemaParseException;

    new-instance v36, Ljava/lang/StringBuilder;

    invoke-direct/range {v36 .. v36}, Ljava/lang/StringBuilder;-><init>()V

    const-string v37, "Undefined name: "
    ...
    invoke-direct/range {v35 .. v36}, Lcom/flurry/org/apache/avro/SchemaParseException;-><init>(Ljava/lang/String;)V

    throw v35

    .line 1107
    .end local v24    # "result":Lcom/flurry/org/apache/avro/Schema;
    :cond_0
    ...
    .line 1111
    .local v21, "name":Lcom/flurry/org/apache/avro/Schema$Name;
    const/16 v25, 0x0

    .line 1112
    .local v25, "savedSpace":Ljava/lang/String;
    const/4 v12, 0x0

    .line 1113
    .local v12, "doc":Ljava/lang/String;
    ...
    .line 1119
    :cond_2
    new-instance v21, Lcom/flurry/org/apache/avro/Schema$Name;

    .end local v21    # "name":Lcom/flurry/org/apache/avro/Schema$Name;
    const-string v35, "name"

    const-string v36, "No name in schema"
    ...
    .line 1121
    .restart local v21    # "name":Lcom/flurry/org/apache/avro/Schema$Name;
    invoke-static/range {v21 .. v21}, Lcom/flurry/org/apache/avro/Schema$Name;->access$600(Lcom/flurry/org/apache/avro/Schema$Name;)Ljava/lang/String;
    ...
    .line 1126
    .end local v27    # "space":Ljava/lang/String;
    :cond_3
    sget-object v35, Lcom/flurry/org/apache/avro/Schema;->PRIMITIVES:Ljava/util/Map;
    ...
    check-cast v35, Lcom/flurry/org/apache/avro/Schema$Type;

    invoke-static/range {v35 .. v35}, Lcom/flurry/org/apache/avro/Schema;->create(Lcom/flurry/org/apache/avro/Schema$Type;)Lcom/flurry/org/apache/avro/Schema;

    move-result-object v24

    .line 1199
    .restart local v24    # "result":Lcom/flurry/org/apache/avro/Schema;
    :cond_4
    :goto_0
    ...
    .line 1200
    .local v17, "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/String;>;"
    :cond_5
    :goto_1
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/flurry/org/codehaus/jackson/JsonNode;->getTextValue()Ljava/lang/String;

    move-result-object v33

    .line 1203
    .local v33, "value":Ljava/lang/String;
    sget-object v35, Lcom/flurry/org/apache/avro/Schema;->SCHEMA_RESERVED:Ljava/util/Set;
    ...
    .line 1128
    .end local v17    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/String;>;"
    ...
    new-instance v24, Lcom/flurry/org/apache/avro/Schema$RecordSchema;
    ...
    invoke-direct {v0, v1, v12, v2}, Lcom/flurry/org/apache/avro/Schema$RecordSchema;-><init>(Lcom/flurry/org/apache/avro/Schema$Name;Ljava/lang/String;Z)V
    ...
    .line 1133
    .local v16, "fieldsNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    if-eqz v16, :cond_9

    invoke-virtual/range {v16 .. v16}, Lcom/flurry/org/codehaus/jackson/JsonNode;->isArray()Z
    ...
    const-string v37, "Record has no fields: "
    ...
    .line 1135
    :cond_a
    invoke-virtual/range {v16 .. v16}, Lcom/flurry/org/codehaus/jackson/JsonNode;->iterator()Ljava/util/Iterator;
    ...
    check-cast v13, Lcom/flurry/org/codehaus/jackson/JsonNode;

    .line 1136
    .local v13, "field":Lcom/flurry/org/codehaus/jackson/JsonNode;
    const-string v35, "name"

    const-string v36, "No field name"

    move-object/from16 v0, v35

    move-object/from16 v1, v36

    invoke-static {v13, v0, v1}, Lcom/flurry/org/apache/avro/Schema;->getRequiredText(Lcom/flurry/org/codehaus/jackson/JsonNode;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13, v0}, Lcom/flurry/org/apache/avro/Schema;->getOptionalText(Lcom/flurry/org/codehaus/jackson/JsonNode;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 1138
    .local v6, "fieldDoc":Ljava/lang/String;
    const-string v35, "type"

    move-object/from16 v0, v35

    invoke-virtual {v13, v0}, Lcom/flurry/org/codehaus/jackson/JsonNode;->get(Ljava/lang/String;)Lcom/flurry/org/codehaus/jackson/JsonNode;

    move-result-object v14

    .line 1139
    .local v14, "fieldTypeNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    if-nez v14, :cond_b
    ...
    const-string v37, "No field type: "
    ...
    .line 1141
    :cond_b
    invoke-virtual {v14}, Lcom/flurry/org/codehaus/jackson/JsonNode;->isTextual()Z
    ...
    const-string v37, " is not a defined name."

    invoke-virtual/range {v36 .. v37}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v36

    const-string v37, " The type of the \""
    ...
    const-string v37, "\" field must be"

    invoke-virtual/range {v36 .. v37}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v36

    const-string v37, " a defined name or a {\"type\": ...} expression."
    ...
    invoke-static {v14, v0}, Lcom/flurry/org/apache/avro/Schema;->parse(Lcom/flurry/org/codehaus/jackson/JsonNode;Lcom/flurry/org/apache/avro/Schema$Names;)Lcom/flurry/org/apache/avro/Schema;

    move-result-object v5

    .line 1148
    .local v5, "fieldSchema":Lcom/flurry/org/apache/avro/Schema;
    sget-object v8, Lcom/flurry/org/apache/avro/Schema$Field$Order;->ASCENDING:Lcom/flurry/org/apache/avro/Schema$Field$Order;

    .line 1149
    .local v8, "order":Lcom/flurry/org/apache/avro/Schema$Field$Order;
    ...
    .line 1150
    .local v22, "orderNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    if-eqz v22, :cond_d

    .line 1151
    invoke-virtual/range {v22 .. v22}, Lcom/flurry/org/codehaus/jackson/JsonNode;->getTextValue()Ljava/lang/String;
    ...
    invoke-static/range {v35 .. v35}, Lcom/flurry/org/apache/avro/Schema$Field$Order;->valueOf(Ljava/lang/String;)Lcom/flurry/org/apache/avro/Schema$Field$Order;
    ...
    .line 1153
    .local v7, "defaultValue":Lcom/flurry/org/codehaus/jackson/JsonNode;
    if-eqz v7, :cond_f

    sget-object v35, Lcom/flurry/org/apache/avro/Schema$Type;->FLOAT:Lcom/flurry/org/apache/avro/Schema$Type;

    invoke-virtual {v5}, Lcom/flurry/org/apache/avro/Schema;->getType()Lcom/flurry/org/apache/avro/Schema$Type;

    move-result-object v36

    invoke-virtual/range {v35 .. v36}, Lcom/flurry/org/apache/avro/Schema$Type;->equals(Ljava/lang/Object;)Z

    move-result v35

    if-nez v35, :cond_e

    sget-object v35, Lcom/flurry/org/apache/avro/Schema$Type;->DOUBLE:Lcom/flurry/org/apache/avro/Schema$Type;
    ...
    :cond_e
    invoke-virtual {v7}, Lcom/flurry/org/codehaus/jackson/JsonNode;->isTextual()Z
    ...
    .line 1157
    new-instance v11, Lcom/flurry/org/codehaus/jackson/node/DoubleNode;

    invoke-virtual {v7}, Lcom/flurry/org/codehaus/jackson/JsonNode;->getTextValue()Ljava/lang/String;
    ...
    invoke-direct {v11, v0, v1}, Lcom/flurry/org/codehaus/jackson/node/DoubleNode;-><init>(D)V

    .end local v7    # "defaultValue":Lcom/flurry/org/codehaus/jackson/JsonNode;
    .local v11, "defaultValue":Lcom/flurry/org/codehaus/jackson/JsonNode;
    move-object v7, v11

    .line 1159
    .end local v11    # "defaultValue":Lcom/flurry/org/codehaus/jackson/JsonNode;
    .restart local v7    # "defaultValue":Lcom/flurry/org/codehaus/jackson/JsonNode;
    :cond_f
    new-instance v3, Lcom/flurry/org/apache/avro/Schema$Field;
    ...
    invoke-virtual {v13}, Lcom/flurry/org/codehaus/jackson/JsonNode;->getFieldNames()Ljava/util/Iterator;

    move-result-object v17

    .line 1162
    .restart local v17    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/String;>;"
    :cond_10
    :goto_3
    invoke-interface/range {v17 .. v17}, Ljava/util/Iterator;->hasNext()Z
    ...
    sget-object v35, Lcom/flurry/org/apache/avro/Schema;->FIELD_RESERVED:Ljava/util/Set;
    ...
    invoke-virtual {v3, v0, v1}, Lcom/flurry/org/apache/avro/Schema$Field;->addProp(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .end local v33    # "value":Ljava/lang/String;
    :cond_11
    invoke-static {v13}, Lcom/flurry/org/apache/avro/Schema;->parseAliases(Lcom/flurry/org/codehaus/jackson/JsonNode;)Ljava/util/Set;

    move-result-object v35

    move-object/from16 v0, v35

    invoke-static {v3, v0}, Lcom/flurry/org/apache/avro/Schema$Field;->access$1302(Lcom/flurry/org/apache/avro/Schema$Field;Ljava/util/Set;)Ljava/util/Set;
    ...
    .end local v5    # "fieldSchema":Lcom/flurry/org/apache/avro/Schema;
    .end local v6    # "fieldDoc":Ljava/lang/String;
    .end local v7    # "defaultValue":Lcom/flurry/org/codehaus/jackson/JsonNode;
    .end local v8    # "order":Lcom/flurry/org/apache/avro/Schema$Field$Order;
    .end local v13    # "field":Lcom/flurry/org/codehaus/jackson/JsonNode;
    .end local v14    # "fieldTypeNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    .end local v17    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/String;>;"
    .end local v22    # "orderNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    :cond_12
    move-object/from16 v0, v24

    invoke-virtual {v0, v15}, Lcom/flurry/org/apache/avro/Schema;->setFields(Ljava/util/List;)V

    goto/16 :goto_0

    .line 1172
    .end local v15    # "fields":Ljava/util/List;, "Ljava/util/List<Lcom/flurry/org/apache/avro/Schema$Field;>;"
    .end local v16    # "fieldsNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    ...
    .line 1174
    .local v29, "symbolsNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    if-eqz v29, :cond_14

    invoke-virtual/range {v29 .. v29}, Lcom/flurry/org/codehaus/jackson/JsonNode;->isArray()Z
    ...
    const-string v37, "Enum has no symbols: "
    ...
    .line 1176
    :cond_15
    new-instance v28, Lcom/flurry/org/apache/avro/Schema$LockableArrayList;

    invoke-direct/range {v28 .. v28}, Lcom/flurry/org/apache/avro/Schema$LockableArrayList;-><init>()V

    .line 1177
    .local v28, "symbols":Lcom/flurry/org/apache/avro/Schema$LockableArrayList;, "Lcom/flurry/org/apache/avro/Schema$LockableArrayList<Ljava/lang/String;>;"
    invoke-virtual/range {v29 .. v29}, Lcom/flurry/org/codehaus/jackson/JsonNode;->iterator()Ljava/util/Iterator;
    ...
    check-cast v20, Lcom/flurry/org/codehaus/jackson/JsonNode;

    .line 1178
    .local v20, "n":Lcom/flurry/org/codehaus/jackson/JsonNode;
    invoke-virtual/range {v20 .. v20}, Lcom/flurry/org/codehaus/jackson/JsonNode;->getTextValue()Ljava/lang/String;
    ...
    .line 1179
    .end local v20    # "n":Lcom/flurry/org/codehaus/jackson/JsonNode;
    :cond_16
    new-instance v24, Lcom/flurry/org/apache/avro/Schema$EnumSchema;
    ...
    invoke-direct {v0, v1, v12, v2}, Lcom/flurry/org/apache/avro/Schema$EnumSchema;-><init>(Lcom/flurry/org/apache/avro/Schema$Name;Ljava/lang/String;Lcom/flurry/org/apache/avro/Schema$LockableArrayList;)V
    ...
    .end local v18    # "i$":Ljava/util/Iterator;
    .end local v24    # "result":Lcom/flurry/org/apache/avro/Schema;
    .end local v28    # "symbols":Lcom/flurry/org/apache/avro/Schema$LockableArrayList;, "Lcom/flurry/org/apache/avro/Schema$LockableArrayList<Ljava/lang/String;>;"
    .end local v29    # "symbolsNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    :cond_17
    const-string v35, "array"
    ...
    .line 1183
    .local v19, "itemsNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    if-nez v19, :cond_18
    ...
    const-string v37, "Array has no items type: "
    ...
    .line 1185
    :cond_18
    new-instance v24, Lcom/flurry/org/apache/avro/Schema$ArraySchema;
    ...
    .end local v19    # "itemsNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    .end local v24    # "result":Lcom/flurry/org/apache/avro/Schema;
    :cond_19
    ...
    .line 1188
    .local v34, "valuesNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    if-nez v34, :cond_1a
    ...
    const-string v37, "Map has no values type: "
    ...
    .line 1190
    :cond_1a
    new-instance v24, Lcom/flurry/org/apache/avro/Schema$MapSchema;
    ...
    .end local v24    # "result":Lcom/flurry/org/apache/avro/Schema;
    .end local v34    # "valuesNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    :cond_1b
    const-string v35, "fixed"
    ...
    .line 1193
    .local v26, "sizeNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    if-eqz v26, :cond_1c

    invoke-virtual/range {v26 .. v26}, Lcom/flurry/org/codehaus/jackson/JsonNode;->isInt()Z
    ...
    const-string v37, "Invalid or no size: "
    ...
    .line 1195
    :cond_1d
    new-instance v24, Lcom/flurry/org/apache/avro/Schema$FixedSchema;

    invoke-virtual/range {v26 .. v26}, Lcom/flurry/org/codehaus/jackson/JsonNode;->getIntValue()I
    ...
    invoke-direct {v0, v1, v12, v2}, Lcom/flurry/org/apache/avro/Schema$FixedSchema;-><init>(Lcom/flurry/org/apache/avro/Schema$Name;Ljava/lang/String;I)V
    ...
    .line 1198
    .end local v24    # "result":Lcom/flurry/org/apache/avro/Schema;
    .end local v26    # "sizeNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    :cond_1e
    new-instance v35, Lcom/flurry/org/apache/avro/SchemaParseException;
    ...
    const-string v37, "Type not supported: "
    ...
    .line 1210
    .local v10, "aliases":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    if-eqz v10, :cond_23
    ...
    invoke-virtual {v0, v9}, Lcom/flurry/org/apache/avro/Schema;->addAlias(Ljava/lang/String;)V

    goto :goto_5

    .line 1215
    .end local v9    # "alias":Ljava/lang/String;
    .end local v10    # "aliases":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .end local v12    # "doc":Ljava/lang/String;
    .end local v17    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/String;>;"
    .end local v18    # "i$":Ljava/util/Iterator;
    .end local v21    # "name":Lcom/flurry/org/apache/avro/Schema$Name;
    .end local v24    # "result":Lcom/flurry/org/apache/avro/Schema;
    .end local v25    # "savedSpace":Ljava/lang/String;
    ...
    .line 1216
    new-instance v32, Lcom/flurry/org/apache/avro/Schema$LockableArrayList;
    ...
    .line 1218
    .local v32, "types":Lcom/flurry/org/apache/avro/Schema$LockableArrayList;, "Lcom/flurry/org/apache/avro/Schema$LockableArrayList<Lcom/flurry/org/apache/avro/Schema;>;"
    ...
    check-cast v31, Lcom/flurry/org/codehaus/jackson/JsonNode;

    .line 1219
    .local v31, "typeNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    ...
    .line 1220
    .end local v31    # "typeNode":Lcom/flurry/org/codehaus/jackson/JsonNode;
    :cond_22
    new-instance v24, Lcom/flurry/org/apache/avro/Schema$UnionSchema;
    ...
    .end local v18    # "i$":Ljava/util/Iterator;
    .end local v32    # "types":Lcom/flurry/org/apache/avro/Schema$LockableArrayList;, "Lcom/flurry/org/apache/avro/Schema$LockableArrayList<Lcom/flurry/org/apache/avro/Schema;>;"
    :cond_23
    return-object v24
    ...
    const-string v37, "Schema not yet supported: "
