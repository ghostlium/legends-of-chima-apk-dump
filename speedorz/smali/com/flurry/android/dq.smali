...
# instance fields
.field private fk:Lcom/flurry/android/FlurryAds;
...
.method constructor <init>(Lcom/flurry/android/FlurryAds;)V
    ...
    .line 15
    iput-object p1, p0, Lcom/flurry/android/dq;->fk:Lcom/flurry/android/FlurryAds;
...
# virtual methods
.method final f(Ljava/util/List;)Ljava/util/List;
    .locals 11
    ...
    .line 25
    invoke-virtual {v0}, Lcom/flurry/android/ck;->ad()J
    ...
    .line 26
    invoke-virtual {v0}, Lcom/flurry/android/ck;->ac()Ljava/lang/String;
    ...
    .line 31
    :try_start_0
    invoke-virtual {v0}, Lcom/flurry/android/ck;->ae()Ljava/util/List;
    ...
    check-cast v1, Lcom/flurry/android/fc;

    .line 34
    invoke-virtual {v1}, Lcom/flurry/android/fc;->aU()Z
    ...
    .line 37
    invoke-virtual {v1}, Lcom/flurry/android/fc;->getType()Ljava/lang/String;
    ...
    .line 38
    invoke-virtual {v1}, Lcom/flurry/android/fc;->aA()J
    ...
    .line 39
    invoke-virtual {v1}, Lcom/flurry/android/fc;->getParams()Ljava/util/Map;
    ...
    .line 58
    :cond_3
    iget-object v0, p0, Lcom/flurry/android/dq;->fk:Lcom/flurry/android/FlurryAds;

    invoke-virtual {v0, p1}, Lcom/flurry/android/FlurryAds;->g(Ljava/util/List;)V
