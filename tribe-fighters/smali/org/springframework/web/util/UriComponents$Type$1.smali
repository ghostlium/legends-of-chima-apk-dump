.class final enum Lorg/springframework/web/util/UriComponents$Type$1;
...
.method public isAllowed(I)Z
    ...
    .prologue
    .line 615
    invoke-virtual {p0, p1}, Lorg/springframework/web/util/UriComponents$Type$1;->isAlpha(I)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lorg/springframework/web/util/UriComponents$Type$1;->isDigit(I)Z
