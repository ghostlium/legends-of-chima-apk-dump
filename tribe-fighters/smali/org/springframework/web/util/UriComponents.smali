...
.field static final NULL_PATH_COMPONENT:Lorg/springframework/web/util/UriComponents$PathComponent;
...
.method constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILorg/springframework/web/util/UriComponents$PathComponent;Lorg/springframework/util/MultiValueMap;Ljava/lang/String;ZZ)V
    ...
    .param p4, "port"    # I
    .param p5, "path"    # Lorg/springframework/web/util/UriComponents$PathComponent;
    ...
    .end local p5    # "path":Lorg/springframework/web/util/UriComponents$PathComponent;
    :goto_0
    ...
    .line 99
    .restart local p5    # "path":Lorg/springframework/web/util/UriComponents$PathComponent;
...
.method static synthetic access$100(Ljava/lang/String;Lorg/springframework/web/util/UriComponents$Type;)V
    ...
    .param p1, "x1"    # Lorg/springframework/web/util/UriComponents$Type;
...
.method static synthetic access$200(Ljava/lang/String;Lorg/springframework/web/util/UriComponents$UriTemplateVariables;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Ljava/lang/String;
    .param p1, "x1"    # Lorg/springframework/web/util/UriComponents$UriTemplateVariables;
...
.method private static encodeBytes([BLorg/springframework/web/util/UriComponents$Type;)[B
    .locals 7
    .param p0, "source"    # [B
    .param p1, "type"    # Lorg/springframework/web/util/UriComponents$Type;
...
.method static encodeUriComponent(Ljava/lang/String;Ljava/lang/String;Lorg/springframework/web/util/UriComponents$Type;)Ljava/lang/String;
    ...
    .param p2, "type"    # Lorg/springframework/web/util/UriComponents$Type;
...
.method private expandInternal(Lorg/springframework/web/util/UriComponents$UriTemplateVariables;)Lorg/springframework/web/util/UriComponents;
    .locals 19
    .param p1, "uriVariables"    # Lorg/springframework/web/util/UriComponents$UriTemplateVariables;
...
.method private static getVariableName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local p0    # "match":Ljava/lang/String;
    :goto_0
    return-object p0

    .restart local p0    # "match":Ljava/lang/String;
    :cond_0
    const/4 v1, 0x0
...
.method private static getVariableValueAsString(Ljava/lang/Object;)Ljava/lang/String;
    .locals 1
    .param p0, "variableValue"    # Ljava/lang/Object;
...
.method public encode(Ljava/lang/String;)Lorg/springframework/web/util/UriComponents;
    ...
    .line 270
    .end local p0    # "this":Lorg/springframework/web/util/UriComponents;
    :goto_0
    return-object p0

    .line 253
    .restart local p0    # "this":Lorg/springframework/web/util/UriComponents;
    :cond_0
    move-object/from16 v0, p0
...
.method public varargs expand([Ljava/lang/Object;)Lorg/springframework/web/util/UriComponents;
    .locals 1
    .param p1, "uriVariableValues"    # [Ljava/lang/Object;
