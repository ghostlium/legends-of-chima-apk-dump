.class final enum Lorg/springframework/web/util/UriComponents$Type$3;
...
.method public isAllowed(I)Z
    ...
    .prologue
    .line 627
    invoke-virtual {p0, p1}, Lorg/springframework/web/util/UriComponents$Type$3;->isUnreserved(I)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lorg/springframework/web/util/UriComponents$Type$3;->isSubDelimiter(I)Z
