.class public final Lcom/google/android/gms/games/multiplayer/realtime/d;
...
.method constructor <init>(Lcom/google/android/gms/common/data/DataHolder;II)V
    ...
    iput p3, p0, Lcom/google/android/gms/games/multiplayer/realtime/d;->rO:I
...
.method public bridge synthetic freeze()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/games/multiplayer/realtime/d;->freeze()Lcom/google/android/gms/games/multiplayer/realtime/Room;
...
.method public getAutoMatchCriteria()Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/games/multiplayer/realtime/d;->getBoolean(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/games/multiplayer/realtime/d;->getInteger(Ljava/lang/String;)I

    move-result v0

    const-string v1, "automatch_max_players"

    invoke-virtual {p0, v1}, Lcom/google/android/gms/games/multiplayer/realtime/d;->getInteger(Ljava/lang/String;)I

    move-result v1

    const-string v2, "automatch_bit_mask"

    invoke-virtual {p0, v2}, Lcom/google/android/gms/games/multiplayer/realtime/d;->getLong(Ljava/lang/String;)J
...
.method public getCreationTimestamp()J
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/games/multiplayer/realtime/d;->getLong(Ljava/lang/String;)J
...
.method public getCreatorId()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/games/multiplayer/realtime/d;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getDescription(Landroid/database/CharArrayBuffer;)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/android/gms/games/multiplayer/realtime/d;->a(Ljava/lang/String;Landroid/database/CharArrayBuffer;)V
...
.method public getParticipants()Ljava/util/ArrayList;
    ...
    iget v0, p0, Lcom/google/android/gms/games/multiplayer/realtime/d;->rO:I
    ...
    :goto_0
    iget v2, p0, Lcom/google/android/gms/games/multiplayer/realtime/d;->rO:I

    if-ge v0, v2, :cond_0

    new-instance v2, Lcom/google/android/gms/games/multiplayer/e;

    iget-object v3, p0, Lcom/google/android/gms/games/multiplayer/realtime/d;->lb:Lcom/google/android/gms/common/data/DataHolder;

    iget v4, p0, Lcom/google/android/gms/games/multiplayer/realtime/d;->ld:I

    add-int/2addr v4, v0

    invoke-direct {v2, v3, v4}, Lcom/google/android/gms/games/multiplayer/e;-><init>(Lcom/google/android/gms/common/data/DataHolder;I)V
