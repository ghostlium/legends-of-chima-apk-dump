...
.field private final kT:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kO:Ljava/util/Set;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kS:Ljava/util/Map;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kT:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kU:Ljava/util/Set;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kR:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/common/api/GoogleApiClient$ConnectionCallbacks;Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kT:Ljava/util/Set;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kU:Ljava/util/Set;
...
.method public addApi(Lcom/google/android/gms/common/api/Api;Lcom/google/android/gms/common/api/GoogleApiClient$ApiOptions;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    .prologue
    iget-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kS:Ljava/util/Map;

    invoke-interface {v0, p1, p2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {p1}, Lcom/google/android/gms/common/api/Api;->aW()Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kO:Ljava/util/Set;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/api/Scope;->be()Ljava/lang/String;
...
.method public addScope(Lcom/google/android/gms/common/api/Scope;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    .prologue
    iget-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kO:Ljava/util/Set;

    invoke-virtual {p1}, Lcom/google/android/gms/common/api/Scope;->be()Ljava/lang/String;
...
.method public bd()Lcom/google/android/gms/internal/dh;
    .locals 6

    new-instance v0, Lcom/google/android/gms/internal/dh;

    iget-object v1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->jD:Ljava/lang/String;

    iget-object v2, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kO:Ljava/util/Set;

    iget v3, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kP:I

    iget-object v4, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kQ:Landroid/view/View;

    iget-object v5, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kR:Ljava/lang/String;

    invoke-direct/range {v0 .. v5}, Lcom/google/android/gms/internal/dh;-><init>(Ljava/lang/String;Ljava/util/Collection;ILandroid/view/View;Ljava/lang/String;)V
...
.method public build()Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->bd()Lcom/google/android/gms/internal/dh;

    move-result-object v2

    iget-object v3, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kS:Ljava/util/Map;

    iget-object v4, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kT:Ljava/util/Set;

    iget-object v5, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kU:Ljava/util/Set;

    const/4 v6, 0x0

    invoke-direct/range {v0 .. v6}, Lcom/google/android/gms/common/api/GoogleApiClient;-><init>(Landroid/content/Context;Lcom/google/android/gms/internal/dh;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;Lcom/google/android/gms/common/api/GoogleApiClient$1;)V
...
.method public setAccountName(Ljava/lang/String;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    .prologue
    iput-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->jD:Ljava/lang/String;
...
.method public setGravityForPopups(I)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    .prologue
    iput p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kP:I
...
.method public setViewForPopups(Landroid/view/View;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    .prologue
    iput-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->kQ:Landroid/view/View;
