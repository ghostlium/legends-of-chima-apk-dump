...
# static fields
.field private static lA:Lcom/google/android/gms/common/images/ImageManager;

.field private static lB:Lcom/google/android/gms/common/images/ImageManager;

.field private static final ly:Ljava/lang/Object;

.field private static lz:Ljava/util/HashSet;
...
.field private final lD:Lcom/google/android/gms/common/images/ImageManager$b;
...
.field private final lF:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->ly:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->lz:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->lC:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->lD:Lcom/google/android/gms/common/images/ImageManager$b;

    invoke-static {}, Lcom/google/android/gms/internal/es;->cn()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/google/android/gms/common/images/ImageManager;->bm()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->lE:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->lF:Ljava/util/Map;
...
.method private a(Lcom/google/android/gms/common/images/a$a;)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->lD:Lcom/google/android/gms/common/images/ImageManager$b;
...
.method public static a(Landroid/content/Context;Z)Lcom/google/android/gms/common/images/ImageManager;
    ...
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->lB:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->lB:Lcom/google/android/gms/common/images/ImageManager;
    ...
    :cond_1
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->lA:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->lA:Lcom/google/android/gms/common/images/ImageManager;
...
.method static synthetic b(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->lF:Ljava/util/Map;
...
.method private b(Lcom/google/android/gms/common/images/a;)Z
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/dg;->B(Ljava/lang/String;)V

    iget v0, p1, Lcom/google/android/gms/common/images/a;->lP:I
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->lE:Ljava/util/Map;
    ...
    :cond_1
    iget-boolean v2, v0, Lcom/google/android/gms/common/images/ImageManager$ImageReceiver;->lH:Z
    ...
    :cond_2
    iget-object v2, p0, Lcom/google/android/gms/common/images/ImageManager;->lE:Ljava/util/Map;
...
.method private bm()V
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/images/ImageManager;->lD:Lcom/google/android/gms/common/images/ImageManager$b;
...
.method static synthetic bn()Ljava/lang/Object;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->ly:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic bo()Ljava/util/HashSet;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->lz:Ljava/util/HashSet;
...
.method static synthetic d(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->lC:Ljava/util/concurrent/ExecutorService;
...
.method public loadImage(Landroid/widget/ImageView;Landroid/net/Uri;I)V
    ...
    invoke-virtual {v0, p3}, Lcom/google/android/gms/common/images/a;->w(I)V
