package starling.textures
{
   ...
   public class SubTexture extends Texture
   {
      ...
      public function SubTexture(param1:Texture, param2:Rectangle = null, param3:Boolean = false, param4:Rectangle = null, param5:Boolean = false)
      {
         ...
         this.mWidth = !!param5 ? Number(this.mRegion.height) : Number(this.mRegion.width);
         this.mHeight = !!param5 ? Number(this.mRegion.width) : Number(this.mRegion.height);
      ...
      override public function adjustVertexData(param1:VertexData, param2:int, param3:int) : void
      {
         ...
         var _loc4_:int = param2 * VertexData.ELEMENTS_PER_VERTEX + VertexData.TEXCOORD_OFFSET;
         var _loc5_:int = VertexData.ELEMENTS_PER_VERTEX - 2;
