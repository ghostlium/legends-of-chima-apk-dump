package starling.textures
{
   ...
   public class Texture
   {
      ...
      public static function fromEmbeddedAsset(param1:Class, param2:Boolean = true, param3:Boolean = false, param4:Number = 1, param5:String = "bgra", param6:Boolean = false) : starling.textures.Texture
      {
         ...
         if(asset is Bitmap)
         {
            texture = starling.textures.Texture.fromBitmap(asset as Bitmap,mipMapping,optimizeForRenderToTexture,scale,format,repeat);
      ...
      public static function fromColor(param1:Number, param2:Number, param3:uint = 4.294967295E9, param4:Boolean = false, param5:Number = -1, param6:String = "bgra") : starling.textures.Texture
      {
         var texture:starling.textures.Texture = null;
      ...
      public static function empty(param1:Number, param2:Number, param3:Boolean = true, param4:Boolean = true, param5:Boolean = false, param6:Number = -1, param7:String = "bgra", param8:Boolean = false) : starling.textures.Texture
      {
         ...
         var _loc15_:Boolean;
         if(_loc15_ = !param4 && !param8 && Starling.current.profile != "baselineConstrained" && "createRectangleTexture" in _loc12_ && param7.indexOf("compressed") == -1)
         {
         ...
         var _loc16_:ConcreteTexture = new ConcreteTexture(_loc11_,param7,_loc9_,_loc10_,param4,param3,param5,param6,param8);
         _loc16_.onRestore = _loc16_.clear;
