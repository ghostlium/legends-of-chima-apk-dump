package starling.core
{
   ...
   public class Starling extends EventDispatcher
   {
      ...
      public function render() : void
      {
         ...
         this.mSupport.setProjectionMatrix(this.mViewPort.x < 0 ? Number(-this.mViewPort.x / _loc1_) : Number(0),this.mViewPort.y < 0 ? Number(-this.mViewPort.y / _loc2_) : Number(0),this.mClippedViewPort.width / _loc1_,this.mClippedViewPort.height / _loc2_,this.mStage.stageWidth,this.mStage.stageHeight,this.mStage.cameraPosition);
