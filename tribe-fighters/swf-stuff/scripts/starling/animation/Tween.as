package starling.animation
{
   ...
   public class Tween extends EventDispatcher implements IAnimatable
   {
      ...
      public function animate(param1:String, param2:Number) : void
      {
         ...
         this.mProperties[this.mProperties.length] = param1;
         this.mStartValues[this.mStartValues.length] = Number.NaN;
         this.mEndValues[this.mEndValues.length] = param2;
      }
