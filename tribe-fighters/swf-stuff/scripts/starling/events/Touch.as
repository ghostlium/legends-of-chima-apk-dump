package starling.events
{
   ...
   public class Touch
   {
      ...
      {
         this.mPreviousGlobalX = this.mGlobalX != this.mGlobalX ? Number(param1) : Number(this.mGlobalX);
      ...
      {
         this.mPreviousGlobalY = this.mGlobalY != this.mGlobalY ? Number(param1) : Number(this.mGlobalY);
