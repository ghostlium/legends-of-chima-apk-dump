package starling.display
{
   ...
   public class QuadBatch extends DisplayObject
   {
      ...
      {
         var _loc2_:QuadBatch = null;
         var _loc3_:QuadBatch = null;
         var _loc5_:int = 0;
         var _loc4_:int = 0;
         while(_loc4_ < param1.length)
         {
            ...
            while(_loc5_ < param1.length)
            {
               ...
               if(!_loc2_.isStateChange(_loc3_.tinted,1,_loc3_.texture,_loc3_.smoothing,_loc3_.blendMode))
               {
                  _loc2_.addQuadBatch(_loc3_);
                  _loc3_.dispose();
      ...
      private static function getImageProgramName(param1:Boolean, param2:Boolean = true, param3:Boolean = false, param4:String = "bgra", param5:String = "bilinear") : String
      {
         ...
         var _loc7_:String;
         if((_loc7_ = sProgramNameCache[_loc6_]) == null)
         {
      ...
      private function expand() : void
      {
         ...
         if(_loc1_ >= MAX_NUM_QUADS)
         {
            throw new Error("Exceeded maximum number of quads!");
         }
         this.capacity = _loc1_ < 8 ? 16 : int(_loc1_ * 2);
      }
      ...
      public function renderCustom(param1:Matrix3D, param2:Number = 1.0, param3:String = null) : void
      {
         ...
         sRenderAlpha[0] = sRenderAlpha[1] = sRenderAlpha[2] = !!_loc4_ ? Number(param2) : Number(1);
      ...
      public function setQuad(param1:Number, param2:Quad) : void
      {
         ...
         param2.copyVertexDataTransformedTo(this.mVertexData,_loc5_,_loc3_);
         if(_loc4_ != 1)
         {
            this.mVertexData.scaleAlpha(_loc5_,_loc4_,4);
         }
         this.mSyncRequired = true;
      }
