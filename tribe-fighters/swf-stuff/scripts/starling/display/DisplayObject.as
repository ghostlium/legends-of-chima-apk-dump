package starling.display
{
   ...
   public class DisplayObject extends EventDispatcher
   {
      ...
      public function set transformationMatrix(param1:Matrix) : void
      {
         ...
         this.mScaleY = this.mSkewX > -_loc2_ && this.mSkewX < _loc2_ ? Number(param1.d / Math.cos(this.mSkewX)) : Number(-param1.c / Math.sin(this.mSkewX));
         this.mScaleX = this.mSkewY > -_loc2_ && this.mSkewY < _loc2_ ? Number(param1.a / Math.cos(this.mSkewY)) : Number(param1.b / Math.sin(this.mSkewY));
