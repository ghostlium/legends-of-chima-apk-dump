package starling.text
{
   ...
   public class TextField extends DisplayObjectContainer
   {
      ...
      private function renderText(param1:Number, param2:Rectangle) : BitmapData
      {
         ...
         var _loc8_:Number = sNativeTextField.textWidth;
         var _loc9_:Number = sNativeTextField.textHeight;
         if(this.isHorizontalAutoSize)
         {
         ...
         var _loc15_:Function;
         if((_loc15_ = "drawWithQuality" in _loc13_ ? _loc13_["drawWithQuality"] : null) is Function)
         {
            _loc15_.call(_loc13_,sNativeTextField,_loc14_,null,null,null,false,StageQuality.MEDIUM);
         }
         else
         {
      ...
      private function calculateFilterOffset(param1:flash.text.TextField, param2:String, param3:String) : Point
      {
         ...
         if((_loc5_ = param1.filters) != null && _loc5_.length > 0)
         {
            ...
            {
               _loc10_ = "blurX" in _loc9_ ? Number(_loc9_["blurX"]) : Number(0);
               _loc11_ = "blurY" in _loc9_ ? Number(_loc9_["blurY"]) : Number(0);
               _loc12_ = "angle" in _loc9_ ? Number(_loc9_["angle"]) : Number(0);
               _loc13_ = "distance" in _loc9_ ? Number(_loc9_["distance"]) : Number(0);
