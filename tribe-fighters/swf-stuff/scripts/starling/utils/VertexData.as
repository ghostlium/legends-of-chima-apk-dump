package starling.utils
{
   ...
   public class VertexData
   {
      ...
      public function setColorAndAlpha(param1:int, param2:uint, param3:Number) : void
      {
         ...
         var _loc5_:Number = !!this.mPremultipliedAlpha ? Number(param3) : Number(1);
      ...
      public function setColor(param1:int, param2:uint) : void
      {
         ...
         var _loc4_:Number = !!this.mPremultipliedAlpha ? Number(this.mRawData[int(_loc3_ + 3)]) : Number(1);
      ...
      public function getColor(param1:int) : uint
      {
         ...
         var _loc3_:Number = !!this.mPremultipliedAlpha ? Number(this.mRawData[int(_loc2_ + 3)]) : Number(1);
         if(_loc3_ == 0)
         {
            return 0;
         }
      ...
      public function getBoundsProjected(param1:Matrix3D, param2:Vector3D, param3:int = 0, param4:int = -1, param5:Rectangle = null) : Rectangle
      {
         ...
         else
         {
            ...
            _loc10_ = param3 * ELEMENTS_PER_VERTEX + POSITION_OFFSET;
            _loc13_ = 0;
            while(_loc13_ < param4)
            {
               _loc11_ = this.mRawData[_loc10_];
               _loc12_ = this.mRawData[int(_loc10_ + 1)];
               _loc10_ += ELEMENTS_PER_VERTEX;
               if(param1)
               {
                  MatrixUtil.transformCoords3D(param1,_loc11_,_loc12_,0,sHelperPoint3D);
               }
               else
               {
      ...
      public function toString() : String
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.numVertices)
         {
            this.getPosition(_loc4_,_loc2_);
            this.getTexCoords(_loc4_,_loc3_);
            _loc1_ += "  [Vertex " + _loc4_ + ": " + "x=" + _loc2_.x.toFixed(1) + ", " + "y=" + _loc2_.y.toFixed(1) + ", " + "rgb=" + this.getColor(_loc4_).toString(16) + ", " + "a=" + this.getAlpha(_loc4_).toFixed(2) + ", " + "u=" + _loc3_.x.toFixed(4) + ", " + "v=" + _loc3_.y.toFixed(4) + "]" + (_loc4_ == this.numVertices - 1 ? "\n" : ",\n");
            _loc4_++;
         }
         return _loc1_ + "]";
      }
