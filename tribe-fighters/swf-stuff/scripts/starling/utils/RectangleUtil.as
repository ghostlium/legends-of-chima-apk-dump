package starling.utils
{
   ...
   public class RectangleUtil
   {
      ...
      public static function intersect(param1:Rectangle, param2:Rectangle, param3:Rectangle = null) : Rectangle
      {
         ...
         var _loc4_:Number = param1.x > param2.x ? Number(param1.x) : Number(param2.x);
         var _loc5_:Number = param1.right < param2.right ? Number(param1.right) : Number(param2.right);
         var _loc6_:Number = param1.y > param2.y ? Number(param1.y) : Number(param2.y);
         var _loc7_:Number = param1.bottom < param2.bottom ? Number(param1.bottom) : Number(param2.bottom);
