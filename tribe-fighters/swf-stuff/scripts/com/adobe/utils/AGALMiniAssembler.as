package com.adobe.utils
{
   ...
   public class AGALMiniAssembler
   {
      ...
      public function assemble(param1:String, param2:String, param3:uint = 1, param4:Boolean = false) : ByteArray
      {
         ...
         {
            if((_loc13_ = (_loc12_ = (_loc12_ = new String(_loc7_[_loc10_])).replace(REGEXP_OUTER_SPACES,"")).search("//")) != -1)
            {
            ...
            if(!(_loc16_ = _loc12_.match(/^\w{3}/ig)))
            {
               if(_loc12_.length >= 3)
               {
                  trace("warning: bad line " + _loc10_ + ": " + _loc7_[_loc10_]);
               }
            }
            else
            {
               ...
               else
               {
                  ...
                  if(_loc17_.flags & OP_VERSION2 && param3 < 2)
                  {
                     this._error = "error: opcode requires version 2.";
                     break;
                  }
                  if(_loc17_.flags & OP_VERT_ONLY && _loc6_)
                  {
                     this._error = "error: opcode is only allowed in vertex programs.";
                     break;
                  }
                  if(_loc17_.flags & OP_FRAG_ONLY && !_loc6_)
                  {
                  ...
                  while(_loc22_ < _loc21_)
                  {
                     ...
                     _loc32_ = _loc22_ == 2 && _loc17_.flags & OP_SPECIAL_TEX;
                     _loc33_ = 0;
                     _loc34_ = 0;
                     _loc35_ = 0;
                     if(_loc31_ && _loc23_)
                     ...
                     if(_loc23_)
                     {
                        ...
                        if((_loc40_ = REGMAP[_loc39_[0]]) == null)
                        {
                        ...
                        if(this.verbose)
                        {
                           trace("RELATIVE: type=" + _loc33_ + "==" + _loc39_[0] + " sel=" + _loc34_ + "==" + _loc41_[0] + " idx=" + _loc28_ + " offset=" + _loc35_);
                        }
                     }
                     if(this.verbose)
                     {
                        trace("  emit argcode=" + _loc26_ + "[" + _loc28_ + "][" + _loc29_ + "]");
                     }
                     if(_loc31_)
                     {
                     ...
                     else if(_loc32_)
                     {
                        ...
                        while(_loc38_ < _loc44_)
                        {
                           if(this.verbose)
                           {
                              trace("    opt: " + _loc15_[_loc38_]);
                           }
                           if((_loc46_ = SAMPLEMAP[_loc15_[_loc38_]]) == null)
                           {
         ...
         if(this.debugEnabled)
         {
            ...
            while(_loc49_ < _loc48_)
            {
               ...
               if((_loc50_ = this.agalcode[_loc49_].toString(16)).length < 2)
               {
                  _loc50_ = "0" + _loc50_;
               }
               _loc47_ += _loc50_;
         ...
         if(this.verbose)
         {
            trace("AGALMiniAssembler.assemble time: " + (getTimer() - _loc5_) / 1000 + "s");
         }
      ...
      {
         REGMAP[VA] = new Register(VA,"vertex attribute",0,!!param2 ? uint(1024) : uint(7),REG_VERT | REG_READ);
         REGMAP[VC] = new Register(VC,"vertex constant",1,!!param2 ? uint(1024) : (param1 == 1 ? uint(127) : uint(249)),REG_VERT | REG_READ);
         REGMAP[VT] = new Register(VT,"vertex temporary",2,!!param2 ? uint(1024) : (param1 == 1 ? uint(7) : uint(25)),REG_VERT | REG_WRITE | REG_READ);
         REGMAP[VO] = new Register(VO,"vertex output",3,!!param2 ? uint(1024) : uint(0),REG_VERT | REG_WRITE);
         REGMAP[VI] = new Register(VI,"varying",4,!!param2 ? uint(1024) : (param1 == 1 ? uint(7) : uint(9)),REG_VERT | REG_FRAG | REG_READ | REG_WRITE);
         REGMAP[FC] = new Register(FC,"fragment constant",1,!!param2 ? uint(1024) : (param1 == 1 ? uint(27) : uint(63)),REG_FRAG | REG_READ);
         REGMAP[FT] = new Register(FT,"fragment temporary",2,!!param2 ? uint(1024) : (param1 == 1 ? uint(7) : uint(25)),REG_FRAG | REG_WRITE | REG_READ);
         REGMAP[FS] = new Register(FS,"texture sampler",5,!!param2 ? uint(1024) : uint(7),REG_FRAG | REG_READ);
         REGMAP[FO] = new Register(FO,"fragment output",3,!!param2 ? uint(1024) : (param1 == 1 ? uint(0) : uint(3)),REG_FRAG | REG_WRITE);
         REGMAP[FD] = new Register(FD,"fragment depth output",6,!!param2 ? uint(1024) : (param1 == 1 ? uint(-1) : uint(0)),REG_FRAG | REG_WRITE);
         REGMAP["op"] = REGMAP[VO];
         REGMAP["i"] = REGMAP[VI];
         REGMAP["v"] = REGMAP[VI];
         REGMAP["oc"] = REGMAP[FO];
