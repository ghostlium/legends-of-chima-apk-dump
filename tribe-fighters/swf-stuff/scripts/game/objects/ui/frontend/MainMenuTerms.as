package game.objects.ui.frontend
{
   ...
   public class MainMenuTerms extends UIComponent
   {
      ...
      public function MainMenuTerms()
      {
         var _loc4_:Vec2F = null;
         var _loc5_:Vec2F = null;
         super();
         this._fBackAlpha = 0;
         this._pScene = new GlaControllerScene(null,null,GameRes.get()._pUISet.findScene("frontend_terms"));
