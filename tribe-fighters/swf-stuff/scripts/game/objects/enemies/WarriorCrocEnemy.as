package game.objects.enemies
{
   ...
   public class WarriorCrocEnemy extends Enemy
   {
       
      
      public function WarriorCrocEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pFireEnemiesCharSet,"enemy_croc_warrior");
