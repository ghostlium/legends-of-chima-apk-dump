package game.objects.enemies.additionals
{
   ...
   public class RangedPredatorEnemy extends Enemy
   {
       
      
      public function RangedPredatorEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pIceAdditionalsCharSet,"enemy_predator_ranged");
