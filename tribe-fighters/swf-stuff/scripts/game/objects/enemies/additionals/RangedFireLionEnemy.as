package game.objects.enemies.additionals
{
   ...
   public class RangedFireLionEnemy extends Enemy
   {
       
      
      public function RangedFireLionEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pFireAdditionalsCharSet,"enemy_firelion_ranged");
