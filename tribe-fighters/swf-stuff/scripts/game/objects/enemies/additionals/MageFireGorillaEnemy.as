package game.objects.enemies.additionals
{
   ...
   public class MageFireGorillaEnemy extends Enemy
   {
       
      
      public function MageFireGorillaEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pFireAdditionalsCharSet,"enemy_firegorilla_mage");
