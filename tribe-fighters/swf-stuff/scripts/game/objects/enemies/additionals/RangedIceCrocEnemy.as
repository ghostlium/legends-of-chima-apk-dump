package game.objects.enemies.additionals
{
   ...
   public class RangedIceCrocEnemy extends Enemy
   {
       
      
      public function RangedIceCrocEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pIceAdditionalsCharSet,"enemy_icecroc_ranged");
