package game.objects.enemies.additionals
{
   ...
   public class MageLeopardEnemy extends Enemy
   {
       
      
      public function MageLeopardEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pFireAdditionalsCharSet,"enemy_leopard_mage");
