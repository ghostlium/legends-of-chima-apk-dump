package game.objects.enemies.additionals
{
   ...
   public class RangedMinimammothEnemy extends Enemy
   {
       
      
      public function RangedMinimammothEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pIceAdditionalsCharSet,"enemy_minimammoth_ranged");
