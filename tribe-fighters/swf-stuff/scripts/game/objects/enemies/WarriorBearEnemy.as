package game.objects.enemies
{
   ...
   public class WarriorBearEnemy extends Enemy
   {
       
      
      public function WarriorBearEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pIceEnemiesCharSet,"enemy_bear_warrior");
