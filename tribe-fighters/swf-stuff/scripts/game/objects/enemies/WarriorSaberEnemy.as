package game.objects.enemies
{
   ...
   public class WarriorSaberEnemy extends Enemy
   {
       
      
      public function WarriorSaberEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pIceEnemiesCharSet,"enemy_saber_warrior");
