package game.objects.enemies
{
   ...
   public class MageLionEnemy extends Enemy
   {
       
      
      public function MageLionEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pFireEnemiesCharSet,"enemy_lion_mage");
