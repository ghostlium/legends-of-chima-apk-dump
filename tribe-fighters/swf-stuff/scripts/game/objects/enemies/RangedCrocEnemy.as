package game.objects.enemies
{
   ...
   public class RangedCrocEnemy extends Enemy
   {
       
      
      public function RangedCrocEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pFireEnemiesCharSet,"enemy_croc_ranged");
