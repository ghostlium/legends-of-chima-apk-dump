package game.objects.enemies.discshooters
{
   ...
   public class DiscShooterSaberEnemy extends DiscShooterEnemy
   {
       
      
      public function DiscShooterSaberEnemy(param1:int, param2:Vec2F)
      {
         super(param1,param2,1,3,GameRes.get()._pIceDiscShooterCharSet,"enemy_saber_discshooter");
