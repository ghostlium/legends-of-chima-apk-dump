package game.objects.bullets
{
   ...
   public class SwordFireBulletUp extends Bullet
   {
       
      
      public function SwordFireBulletUp(param1:Vec2F, param2:Vec2F, param3:int, param4:int)
      {
         super(GameConsts.eFireChima,param3,param4,1,"sword_fire_bullet_up",param1,param2,4);
      }
