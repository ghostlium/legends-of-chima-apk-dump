package game.objects.bullets
{
   ...
   public class WandIceBullet extends Bullet
   {
       
      
      public function WandIceBullet(param1:Vec2F, param2:Vec2F, param3:int, param4:int)
      {
         super(GameConsts.eIceChima,param3,param4,1,"wand_ice_bullet",param1,param2,0.5);
      }
