package game.objects.bullets
{
   ...
   public class SwordIceBulletUp extends Bullet
   {
       
      
      public function SwordIceBulletUp(param1:Vec2F, param2:Vec2F, param3:int, param4:int)
      {
         super(GameConsts.eIceChima,param3,param4,1,"sword_ice_bullet_up",param1,param2,4);
      }
